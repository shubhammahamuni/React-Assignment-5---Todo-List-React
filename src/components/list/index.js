        ...
        <ul>
...

           {
               list.map((obj,i)=>{
                 ...
                 {  obj.edit==true ?<><textarea className="editTask" defaultValue={obj.task_name}  onChange={(e)=>handle_edit(e.target.value , i)}/>
                        
                        <button className="saveTask" onClick = {()=>{handle_edit_save_button(i)}}>save</button></>:null}
